...
use coolapk::commands::{
    ...
    follow_collection, follow_dyh, follow_tag, follow_user, get_album_detail, get_album_list,
    ...
    get_my_product_list, get_node_feeds, get_notification_count, get_notifications, get_picture_list,
    get_product_albums, get_product_brand_list, get_product_category_list, get_product_config,
    get_product_detail, get_product_detail_by_name, get_product_feeds, get_product_list,
    ...
    list_chat_history, list_messages, get_recent_chat_users, login_as, login_by_account, login_by_mobile,
