...
use coolapk::commands::{
    ...
    create_feed, create_forward, create_goods_list, create_product_album, delete_feed,
    delete_goods_list_items, delete_reply, download_update, edit_goods_list, edit_goods_list_item,
    export_json_file, favorite_apk, favorite_feed, fetch_external_page, follow_collection,
    follow_dyh, follow_tag, follow_user, get_album_detail, get_album_list, get_album_replies,
    get_apk_discoverers,
    get_apk_feeds, get_apk_gift_list, get_apk_qr, get_apk_recommend_list, get_apk_url,
    get_apk_related_apps, get_app_detail, get_apk_comments, get_app_list, get_black_list,
    get_board_feeds, get_cache_info,
    ...
    get_node_feeds, get_notification_count, get_notifications, get_picture_list,
    get_product_albums, get_product_detail, get_product_detail_by_name, get_product_feeds,
    get_question_answers, get_user_product_albums,
